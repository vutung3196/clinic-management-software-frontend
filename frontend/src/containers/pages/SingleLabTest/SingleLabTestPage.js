...
const SingleLabTestPage = (props) => {
  ...
  const [labTest, setLabTestForm] = useState(init);
  const [date, setDate] = useState("");

  useEffect(() => {
    labtestService.getById(props.match.params.id).then(
      (response) => {
        setLabTestForm(response.data);
        ...
        >
          ...
          >
            ...
            <div style={{ "text-align": "center" }}>
              ...
              <div>Mã phiếu chỉ định: {labTest.labOrderFormCode} </div>
            </div>
              ...
              <table class="tab_table" style={{ width: "100%", padding: 0 }}>
                <tbody>
                  <tr>
                    ...
                    <td>
                      <strong>{labTest.patientInformation.fullName}</strong>
                    </td>
                    <td
                      style={{
                        width: "80px",
                    ...
                    >
                      {labTest.patientInformation.age}
                    </td>
                  </tr>
                  <tr>
                    <td
                    ...
                    >
                      {labTest.patientInformation.phoneNumber}
                    </td>
                    <td
                      style={{
                        "vertical-align": "top",
                    ...
                    >
                      {labTest.patientInformation.gender}
                    </td>
                  </tr>
                  <tr>
                    <td
                    ...
                    >
                      {labTest.patientInformation.addressCity}
                    </td>
                  </tr>
                  <tr>
                    <td
                    ...
                    >
                      {labTest.patientInformation.medicalInsuranceCode}
                    </td>
                  </tr>
                  <tr>
                    <td
